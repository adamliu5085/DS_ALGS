...
public class TestPathFinder {
	...
	public static void main(String[] args) {	
		...
		PathFinder.solveMaze("assignment8_files/random.txt", "assignment8_files/testOutput1.txt", true);
		// Run the pathfinder with a final argument of false to find any path to any goal
		PathFinder.solveMaze("assignment8_files/random.txt", "assignment8_files/testOutput2.txt", false);
	}
}
