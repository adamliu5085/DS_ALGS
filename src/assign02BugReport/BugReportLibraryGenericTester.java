...
/** SETUP JUNIT FROM ORIGONAL ASSIGNMENT 2 
 * 
 * @author Adam Liu
 * 
 */
public class BugReportLibraryGenericTester {
	...
	private LibraryGeneric<String> nameLib;
	private LibraryGeneric<PhoneNumber> phoneLib;  
	private LibraryGeneric<String> smallLib, mediumLib;
	...
	public void testOverdueListPastDueDateOnAllCheckedOutBooksSortedProperly() {
		...
		mediumLib.checkout(9781843190769L, "Timiri Blagg", 9, 4, 2022);
	...
	public void testNotEveryCheckedOutBookIsOverdue() {
		...
		assertEquals(2, mediumLib.getOverdueList(9, 4, 2022).size());
	...
	public void testOverdueListReturnsEmptyWithBooksCheckedOut() {
		...
		ArrayList<LibraryBookGeneric<String>> list = mediumLib.getOverdueList(11, 30, 2022);
